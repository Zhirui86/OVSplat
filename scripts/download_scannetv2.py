...
def get_release_scans(release_file):
    ...
    train_val_test = [
        '/data/gyy/Semantic-Ray/configs/scannetv2_val_split.txt',
        '/data/gyy/Semantic-Ray/configs/scannetv2_train_split.txt',
        '/data/gyy/Semantic-Ray/configs/scannetv2_test_split.txt'
    ]
    scans = []
